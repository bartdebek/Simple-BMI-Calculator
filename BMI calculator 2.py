...
if z > 24.9:
    print("\n\nYou are a little bit overweight, try healthier diet and excercising!\n\nFor healthy weight reduction you should maintain daily deficit of about 300kcal.\nThis means eating about {} kcal a day" .format(kcal))
          
elif z <24.9 and z >= 18.5:
    print("\n\nYour weight is ok, congratulations!")

else:
    print("\n\nYou are underweight, try gaining some kilograms!\n\nFor healthy weight gain you should maintain daily surplus of about 300kcal.\nThis means eating about {} kcal a day" .format(kcal))
